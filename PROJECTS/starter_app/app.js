...
var _BASE_PATH = _PROJECTS_PATH + 'starter_app/';
module.exports = {
	basePath: _BASE_PATH,
	assetsPath: _BASE_PATH + '_src/assets/',
    buildDir: _BASE_PATH + 'build/',
    dataDir: _BASE_PATH + 'datas/',
    pageDir: _BASE_PATH + 'pages/',
	scssDir: _BASE_PATH + '_src/_scss/',
	cssDir: _BASE_PATH + '_src/assets/css/',
	jsDir: _BASE_PATH + '_src/assets/js/',
    markedConfig: {
    ...
    copy: [
        {
            src: [
				_BASE_PATH + '_src/assets/css/*.map',
                _BASE_PATH + 'images/**/*.{jpg,png}',
                _BASE_PATH + '_src/assets/fonts/**/*.{eot,svg,ttf,woff,woff2,otf}'
            ],
            base: _BASE_PATH,
            watch:true
        }
